    ...
    <header className="sticky top-0 z-50 bg-slate-900/95 backdrop-blur-md border-b border-slate-800 shadow-lg text-white">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3 group">
          <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-slate-900 via-slate-800 to-zinc-950 flex items-center justify-center text-white shadow-[0_0_20px_rgba(245,158,11,0.15)] border border-amber-500/30 group-hover:border-amber-400 group-hover:shadow-[0_0_25px_rgba(245,158,11,0.3)] transition-all duration-500 transform group-hover:scale-105">
            <span className="bg-gradient-to-br from-amber-400 via-yellow-300 to-orange-500 bg-clip-text text-transparent font-black text-2xl italic tracking-wider">
              B
            </span>
          </div>
        ...
        <div className="flex items-center gap-5">
          ...
          {user ? (
            <div className="flex items-center gap-4">
              <Link to="/profile" className="hidden sm:flex items-center gap-2 text-slate-300 hover:text-white transition">
