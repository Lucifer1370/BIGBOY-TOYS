      ...
      <Card className="w-full max-w-md bg-slate-900/60 backdrop-blur-md border border-slate-850 shadow-2xl rounded-3xl z-10 p-2">
          ...
          <div className="flex flex-col gap-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-2">
                <Label htmlFor="firstName" className="text-slate-300 text-xs font-bold uppercase tracking-wider">First Name</Label>
                <Input
              ...
              <div className="grid gap-2">
                <Label htmlFor="lastName" className="text-slate-300 text-xs font-bold uppercase tracking-wider">Last Name</Label>
                <Input
                  className="h-11 rounded-xl bg-slate-950 border border-slate-850 text-slate-100 placeholder:text-slate-700 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition px-4 py-2"
                  id="lastName"
                  name="lastName"
        ...
        <CardFooter className="flex-col gap-4 pt-4">
          ...
          <p className="text-xs text-slate-400">
            ...
            <Link
              to={"/login"}
              className="font-extrabold text-blue-400 hover:text-blue-300 transition-colors"
            >
              Login
            </Link>
          </p>
